...
class ClipModel extends Model
{
    ...
    protected $allowedFields = [
        'title', 'keyword', 'category', 'file_mime', 'thumb_file', 'save_file', 'svg_file', 'org_file', 'file_size', 'hit', 'use_flag' , 'img_w' , 'img_h' , 'paid_yn', 'reg_date', 'reg_ip', 'reg_id', 'mod_date', 'mod_ip', 'mod_id'
    ];
