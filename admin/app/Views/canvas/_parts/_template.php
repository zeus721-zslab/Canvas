...
<div class="d-flex flex-column mt-4">
    <div class="d-flex position-relative">
        <input name="search-text" class="form-control" style="padding-left: 2rem;box-sizing: border-box" value="" placeholder="탬플릿 검색" />
                ...
                <div class="overflow-hidden">
                    <div class="image-list" style="overflow: hidden;width: 100vw">
                        <div class="image-list-inner justified-gallery editor_imglistall">
                            <?php foreach ($r['templates'] as $kk => $rr) { ?>
                                <a class="<?=$kk == 0 ? "active" : ""?>">
                                    <img src="<?=$rr["thumb_file"]?>" class="objItemTemplate canvas-img" data-idx='<?=$rr['template_id']?>' data-w="" data-h="">
                                </a>
                            <?php }?>
