...
<html>
<head>
    <link href="/canvas/js/jplayer/skin/blue.monday/css/jplayer.blue.monday.min.css" rel="stylesheet" type="text/css" />

    <script type="text/javascript" src="/canvas/js/jquery-1.9.1.min.js"></script>
    <script type="text/javascript" src="/canvas/js/jplayer/jquery.jplayer.min.js"></script>
</head>

<body style="padding:0px; margin:0px; background-color:#fff;font-family:helvetica, arial, verdana, sans-serif">

<script src="/canvas/js/slider/jssor.slider-21.1.6.js" type="text/javascript"></script>
<script>
    jQuery(document).ready(function ($) {
        ...
        jssor_slider1.$On($JssorSlider$.$EVT_PARK,function(nPosId,nPrevId){
            ...
            $("#btnClipPlay_"+nPrevId).attr("src","/canvas/images/btn/play_opa200.png");
...
<STYLE type="text/css">
    ...
    .jssorb05 div, .jssorb05 div:hover, .jssorb05 .av {
        ...
        width: 16px;
        height: 16px;
        background: url('/canvas/js/slider/img/b05.png') no-repeat;
        overflow: hidden;
        cursor: pointer;
    }
    ...
    .jssora22l, .jssora22r {
        ...
        height: 58px;
        cursor: pointer;
        background: url('/canvas/js/slider/img/a22.png') center center no-repeat;
        overflow: hidden;
    }
...
<div id="slider1_container" class='objScreen' style="position: relative; top: 0px; left: 0px;">
    <div class='objSlideWrap' u="slides" style="cursor: move; position: absolute; overflow: hidden; left: 0px; top: 0px; width: 600px; height: 300px;background-color:#000;background-image:url('/canvas/images/wm_black_2212.png');">
    ...
    <div data-u="thumbnavigator" class="jssort03 objThumb" style="position:absolute;left:0px;bottom:0px;width:600px;height:60px;" data-autocenter="1">
        ...
        <div style='position:absolute;margin-top:20px;right:20px;'>
            <span style='display:inline-block;border-radius:5px;padding:3px 10px;background-color:#fff;cursor:pointer;color:#000;font-weight:bold;font-size:13px;' id='btnPrint'><IMG src='/canvas/images/printer20.png' align='absmiddle'> 인쇄하기</span>
        </div>
    </div>
