...
<div class="d-flex flex-column w-100 p-3">
    ...
    <ul class="w-100 d-flex list-unstyled --pop-memberinfo-tab">
        ...
        <li><a class="active text-decoration-none" href="/UserManagement/login_info_pop?id=<?=$aInfo['id']?>">로그인내역</a></li>
    </ul>
        ...
        <div class="row">
            <table class="table table-bordered my-3">
                ...
                <tr>
                    ...
                    <th class="bg-light text-center">로그인시간</th>
                </tr>
                </thead>
                <tbody>
