...
<body> <!--begin::App Wrapper-->
    ...
    <div class="d-flex flex-column w-100 p-3">
        ...
        <ul class="w-100 d-flex list-unstyled --pop-memberinfo-tab">
            <li><a class="active text-decoration-none" role="button" href="/UserManagement/member_info_pop?id=<?=$aInfo['id']?>">회원정보</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <table class="table table-bordered my-3">
                    <tr>
                        <th class="bg-light w-25 text-center">유료여부</th>
                        <td>
                            <?php if($aInfo['e_use_date'] > date('Ymd')){?>
                                <div class="d-flex flex-column gap-2">
                                    <b>유료회원</b>
                                    <span>이용기간 : <?=view_date_format($aInfo['s_use_date'],5)?> ~ <?=view_date_format($aInfo['e_use_date'],5)?></span>
                                </div>
                            <?php }else{?>
                                <div class="d-flex flex-column gap-2">
                                    <span>일반회원</span>
                    ...
                    <tr>
                        <th class="bg-light w-25 text-center">아이디</th>
                        <td><?=$aInfo['login_id']?></td>
                    </tr>
                    <tr>
                        <th class="bg-light w-25 text-center">이름</th>
                        <td><?=$aInfo['username']?></td>
                    </tr>
                    <tr>
                        <th class="bg-light w-25 text-center">이메일</th>
                        <td><?=$aInfo['user_email']?></td>
                    </tr>
                    <tr>
                        <th class="bg-light w-25 text-center">연락처</th>
                        <td><?=$aInfo['cell_tel']?></td>
                    </tr>
                    <tr>
                        <th class="bg-light w-25 text-center">회원가입일</th>
                        <td><?=$aInfo['created_at']?></td>
                    </tr>

                    <tr>
                        <th class="bg-light w-25 text-center">꼬망세연동</th>
                        <td>
                            <?php if($aInfo['cmc_vcID']){?>
                                <b class="text-primary">꼬망세 연동회원</b>
                                <br>
                                <span>( <?=$aInfo['cmc_vcID']?> )</span>
                            <?php }else{?>
                                <span>일반가입 회원</span>
                            <?php }?>
                        </td>
                    ...
                    <tr>
                        <th class="bg-light w-25 text-center">탈퇴여부</th>
                        <td>
                            <?php if($aInfo['deleted_at']){?>
                                <span class='text-danger'>탈퇴<br>(탈퇴일: <?=$aInfo['deleted_at']?>)</span>
                            <?php }else{?>
                                <span>정상</span>
                            <?php }?>
                        </td>
