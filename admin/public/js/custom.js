...
$(function(){
    ...
    $(document).on('click','.meminfo-win',function(e){
        e.preventDefault();

        var userid = $(this).data('id');
        var win = window.open('','member_info_winpop','width=800,height=600,left=0,top=0');
        win.location.href = '/UserManagement/member_info_pop?id='+userid;
    });
