...
<div class="row">
    <div class="col-12 border-bottom py-3 d-flex">
        <button class="btn flex-grow-1 objFTA objFTA_left" data-val="left" title="좌측정렬"> <img src="/images/easycanvas/easycv_icon_txtleft.png" /> </button>
        <button class="btn flex-grow-1 objFTA objFTA_center" data-val="center" title="가운데정렬"> <img src="/images/easycanvas/easycv_icon_txtcenter.png" /> </button>
        <button class="btn flex-grow-1 objFTA objFTA_right" data-val="right" title="오른쪽정렬"> <img src="/images/easycanvas/easycv_icon_txtright.png" /> </button>
        <button class="btn flex-grow-1 objFTA objFTA_justify" data-val="justify" title="양쪽정렬"> <img src="/images/easycanvas/easycv_icon_txtall.png" /> </button>
    </div>
</div>
